...
//        ResponseEntity<Long> responseEntity = restTemplate.postForEntity(url, requestDto, Long.class);
        ...
        //then
        /*
        assertThat(responseEntity.getStatusCode()).isEqualTo(HttpStatus.OK);//ResponseEntity(body,null,status)
        assertThat(responseEntity.getBody()).isGreaterThan(0L);
        //post방식으로 전달된 request는 body에 data가 닮겨서 저장된다.
        //HttpEntity를 통하여 body를 전달 받을 경우 httpEntity(responseEntity).getBody()
        //.isGreaterThan(0L); 0L보다 크다는 뜻 즉 전달받은 data가 있냐는 뜻?
        */
